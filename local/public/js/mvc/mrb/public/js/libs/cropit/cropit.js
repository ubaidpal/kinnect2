	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function getCroppedImageData(exportOptions) {
		 ...
		 var profileImage = '<?php echo Kinnect2::getPhotoUrl("thumb.normal");?>';
		 var s = this.imageSrc;
		 
		 if(s.length < 1){s = profileImage;}
		 
		 if(s.indexOf("jpeg") > -1 ){
			myImageType = "image/jpeg";
		 }
		 
		 if(s.indexOf("jpg") > -1 ){
			myImageType = "image/jpg";
		 }
		 
		 if(s.indexOf("png") > -1 ){
			myImageType = "image/png";
		 }
		 
		 if(s.indexOf("gif") > -1 ){
			myImageType = "image/gif";
		 }
	      ...
	      if (exportOptions.type === 'image/png') {
