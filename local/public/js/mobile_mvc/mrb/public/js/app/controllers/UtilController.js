define(
    ...
    return Backbone.Marionette.Controller.extend({
        ...
        getConfirmationPopup: function(options){ // text, confirmCallback, cancelCallback
            var text = options.text;
            //var r = confirm(text);
            //if (r == true && options.confirmCallback) {
            //    options.confirmCallback(options.options)
            //} else if(options.cancelCallback) {
            //    options.cancelCallback(options.options)
            //}
            //
            //
            /////---- //
            ...
            $("#mvc-global-confirmation-popup .global-confirm-yes").click(function(){
                options.confirmCallback(options.options);
