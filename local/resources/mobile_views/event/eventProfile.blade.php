                    ...
                    <div class="details">
                        ...
                        <div class="details-list">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="dtl-value">
                                <span class="mb5"><a
                                            href="javascript:void(0);">{{Kinnect2::countEventGuestAttending($event->id)}}</a> Attending</span>
                                <span class="mb5"><a
                                            href="javascript:void(0);">{{Kinnect2::countEventGuestMaybeAttending($event->id)}}</a> May be attending</span>
                                <span class="mb5"><a
                                            href="javascript:void(0);">{{Kinnect2::countEventGuestNotAttending($event->id)}}</a> Not attending</span>
                                    @if($event->approval_required == 1)
                                        <span class="mb5"><a
                                                    href="javascript:void(0);">{{Kinnect2::countEventGuestAwaitingReplyAttending($event->id)}}</a> Awaiting reply</span>
                                    @endif
                                    @if(Kinnect2::isEventOwner($event) OR Kinnect2::isEventGroupOwner($event,Auth::user()->id))
                                        <span class="mb5"><a
                                                    href="javascript:void(0);">{{Kinnect2::countEventInvitesSentTo($event->id)}}</a> Invites Sent</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        @if(count($eventInvitesSentToMembers) > 0)
                            @foreach($eventInvitesSentToMembers as $eventInvitesSentToMember)
                                <div class="my-battles">
                                    ...
                                    <div class="tag-post">
                                        <div class="tag"><a
                                                    href="{{url(Kinnect2::profileAddress($eventInvitesSentToMember))}}">{{$eventInvitesSentToMember->displayname}}</a>
                                        </div>
