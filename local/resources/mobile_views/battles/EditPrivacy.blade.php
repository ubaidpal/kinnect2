...
<p>Edit your battle privacy below, then click "Save Privacy" to apply the new privacy settings for the battle.</p>


  <div class="form-container">
  {!! Form::model($battle , ['method' => 'PATCH', 'url' => "battles/update/".$battle->id]) !!}
    ...
    <div class="field-item">
       ...
       <select name="auth_allow_view" id="view_privacy">
           {{$eventViewPrivacySetting = Kinnect2::getAuthAllowSetting('battle', $battle->id, 'view') }}
    ...
    <div class="field-item">
        ...
        <select name="auth_allow_comment" id="view_privacy">
            {{$eventViewPrivacySetting = Kinnect2::getAuthAllowSetting('battle', $battle->id, 'comment') }}
            @foreach($settingItems as $index => $settingItem)
                <?php
                echo "<option value='".$settingItem[0]."' ";
                if($index == $eventViewPrivacySetting){
    ...
    <div class="">
       ...
       {!! Form::label('searchlabel' , 'Show this battle in search results') !!}
    </div>
