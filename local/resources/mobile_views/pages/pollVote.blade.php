...
<div class="post-container">
	<div class="post-wrapper">
		...
		<div class="post-story-centainer">
			<div class="poll-title">Technology</div>
            <div class="poll-sub-title">Whick one is best soft drink?</div>
            <div class="poll-vote-box">
           		<div class="poll-item-name">Coca Cola</div> 
                <div class="poll-item-select">
                    <label class="rad">
            ...
            <div class="poll-vote-box">
           		<div class="poll-item-name">Pepsi</div> 
                <div class="poll-item-select">
                    <label class="rad">
                        <input type="radio" name="first-name" value="a">
                        <i></i> Everyone
            ...
            <div class="poll-vote-box">
           		<div class="poll-item-name">Sprite</div> 
                <div class="poll-item-select">
                    <label class="rad">
                        <input type="radio" name="first-name" value="a">
                        <i></i> Everyone
