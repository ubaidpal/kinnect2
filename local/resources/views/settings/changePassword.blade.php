    ...
    <div class="form-container settings">
        <form  role="form" method="POST" action="password_change" >
            ...
            <div class="field-item">
                ...
                <input type="password" id="password" name="password" placeholder="new Password format e.g.Kinnect2#" required class="form-control" value="">
            </div>
            ...
            <p class="mt10">Please note that after reset password you will be logged out and you have to login agian with new password.</p>
        </form>
        @if (count($errors) > 0)
