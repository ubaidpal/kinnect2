...
@section('content')
    <style type="text/css">
        .cropit-image-preview{border-radius: 0 ;margin-left: 5px;}
        p.error{color:#ff7158;margin-top: 5px;}
        #start_time_hour-error,#end_time_hour-error{margin-left: 105px;}
        div#edit_profile_photo_inline{width: 262px;}
        .cropit-image-background-container{width: 282px !important;height: 275px !important;}
        button.cancel_profile_light_box{margin-right: 30px;}
    </style>
    ...
    <div class="field-item">
        ...
        @if($errors->isDateValid->any())
            ...
            <div class="select-date">
                ...
                <input type="text" readonly class="fltL" name="start_date" value="{{$now_date}}" title="Select date to start." id="start_date">
            </div>
        ...
        <div class="field-item calendar">
            ...
            <div class="select-date">
                <span>Select a Date</span>
                <input type="text" readonly name="end_date" class="fltL" title="Select date to end." id="end_date">
        ...
        <div class="field-item">
            ...
            @if($errors->has('location'))<p class="error">{{$errors->first('location')}}</p> @endif
        </div>
...
@section('footer-scripts')
    ...
    <script type="text/javascript" src="{!! asset('/local/public/cropit/cropit.js') !!}"></script>
    <script type="text/javascript">
        ...
        jQuery(document).on('click','#event_create_btn',function (e) {
           e.preventDefault();
           jQuery('#event_form_details').submit();
        });
       /*function check_dates(e){
        ...
        $(document).ready(function(){
            ...
            jQuery('#event_form_details').validate({
                errorElement : 'p',
                errorPlacement : function (error,elem) {
                    if(elem.attr('name') == 'start_time_hour'){
                        error.insertAfter('#start_time_am_pm');
                    }else if(elem.attr('name') == 'end_time_hour'){
                        error.insertAfter('#end_time_am_pm');
                    }else {
                        if (elem.next().is('p')) {
                            elem.next().remove();
                        }
                ...
                messages : {
                    ...
                    'end_date' : {
                        required : "{{trans('validation.required',['attribute' => 'end date'])}}"
                    },
                    'start_time_hour' : {
                        required : "{{trans('validation.required',['attribute' => 'start time'])}}"
                    },
                    'end_time_hour' : {
                        required : "{{trans('validation.required',['attribute' => 'end time'])}}"
                    },
                    'location' : {
                        required : "{{trans('validation.required',['attribute' => 'location'])}}"
                    }
                }
            });
