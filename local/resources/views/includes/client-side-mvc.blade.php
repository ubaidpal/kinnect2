<script>
    ...
    var urlTokens = window.location.href.split(myhost);

    console.log("------");
    var rootTokens = urlTokens[1].split("/");
    console.log(rootTokens);
    var rootParent = rootTokens[1];
    var appPath = '';
    if(rootParent == 'home' || rootParent == 'home'){
        appPath = '';
    }else if(rootParent == 'profile'){
        appPath = '..';
    }else if(rootParent == 'group'){
        appPath = '..';
    }else if(rootParent == 'brand'){
        appPath = '..';
    }else if(rootParent == 'postDetail'){
        appPath = '..';
    }
    ...
    (function(ua, w, d, undefined) {
        ...
        appPublicPath = requirePath+'local/public/js/mvc/mrb/public/';
        ...
        if((/iPhone|iPod|iPad|Android|BlackBerry|Opera Mini|IEMobile/).test(ua)) {
            ...
            filesToLoad = {
                ...
                "dev-js": { "data-main": "js/app/config/config.js", "src": "local/public/js/mvc/mrb/public/js/libs/require.js" },
        ...
        // Desktop Logic
            ...
            filesToLoad = {
                ...
                "dev-js": { "data-main": appPublicPath+"js/app/config/config.js", "src": appPublicPath+"js/libs/require.js" },
                // JavaScript initialization file that is loaded when in development mode
                "dev-init": appPublicPath+"js/app/init/DesktopInit.js",
                // JavaScript file that is loaded when in production mode
                "prod-init": appPublicPath+"js/app/init/DesktopInit.min.js",
                "prod-js": { "data-main": appPublicPath+"js/app/config/config.js", "src": appPublicPath+"js/libs/require.js" }
            };
...
<div class="modal-box" id="mvc-global-confirmation-popup">
    <a href="#" class="js-modal-close close">×</a>
    <div class="modal-body">
        <div class="edit-photo-poup" style="overflow: auto">
            <h3 class="popup-title">Confirmation Required!</h3>
            <p class="popup-text" style="margin-top: 10px;margin-bottom: 15px;">Are you sure you want to perform this action?</p>
            <div>
                <input class="orngBtn fltL global-confirm-yes" type="button" value="Yes">
                <input class="orngBtn js-modal-close close fltL ml10 global-confirm-cancel" type="button" value="No">
            </div>
        </div>
    </div>
</div>
...
<div class="modal-box" id="mvc-global-confirmation-popup-overpopup">
    <a href="#" class="js-modal-close close">×</a>
    <div class="modal-body">
        <div class="edit-photo-poup" style="overflow: auto">
            <h3 class="popup-title">Confirmation Required!</h3>
...
<div class="modal-box" id="mvc-global-popup">
    <a href="#" class="js-modal-close close">×</a>
    <div class="modal-body">
