...
@section('content')
    <style type="text/css">
        .group_profile_img{  border-radius: 50%; }
...
<div class="form-container">
    {!! Form::model($group , ['method' => 'PATCH', 'url' => "group/update/".$group->id, "enctype"=>"multipart/form-data",'id' => 'editGroup']) !!}
