...
@section('content')
    ...
    <div class="ad_main_wrapper">
        ...
        {!! Form::open(['id' => 'wholeform', "id" => "ad-detail-form", "enctype"=>"multipart/form-data"]) !!}
                            ...
                            <div class="form-elements">
                               ...
                               <!-- <div id="package_name-wrapper" class="form-wrapper">
                                ...
                                <div id="campaign_id-wrapper" class="form-wrapper">
                                    ...
                                    {!!  Form::select('campaign_id', $campaigns, null, ['id' => 'campaign_id', 'onchange' => 'updateTextFields(this.value);'])!!}
                                    @if($errors->first('campaign_id'))
                                        <span>{{ $errors->first('campaign_id') }}</span>
                                    @endif

                                </div>
                                <div id="campaign_name-wrapper" class="form-wrapper">
                                ...
                                <div id="title-wrapper" class="form-wrapper" style="display: none;">
                                    <div id="title-label" class="form-label">
                                        <label for="title" class="optional">Select Content</label>
                                    </div>
                                ...
                                <div id="cads_url-wrapper" class="form-wrapper">
                                    ...
                                    <div id="cads_url-element" class="form-element"><p class="description">Example: http://www.yourwebsite.com/</p>
                                        ...
                                        <input type="text" name="cads_url" id="cads_url" value="http://"></div>
                                </div>
                                ...
                                <div id="cads_body-wrapper" class="form-wrapper">
                                    ...
                                    <div id="cads_body-element" class="form-element"><p class="description">
                                        ...
                                        <textarea name="cads_body" id="cads_body" cols="45" rows="6" maxlength="170"
                                                  wrap="hard"></textarea>
                                    </div>
                                </div>
                                            ...
                                            <div class="cmaddis">
                                                <div class="cmad_addis">
                                                    <div class="cmad_show_tooltip_wrapper">
                                                        <div class="cmaddis_title" id="ad_title"><a href="javascript:void(0);">Example Ad Title</a></div>
                                                    </div>
                                                    <div class="cmad_show_tooltip_wrapper">
                                                        <div class="cmaddis_image cmaddis_sample" id="ad_photo">
                                                            <img id="image_preview"
                                                                 src="{{ asset('local/public/assets/images/blankImage.png') }}">
                                                        </div>
                                                    </div>
                                                    <div class="cmad_show_tooltip_wrapper">
                                                        <div class="cmaddis_body cmad_show_tooltip_wrapper" id="ad_body">
                                                            Example ad body text.
                                                        </div>
                                                    </div>
                                ...
                                <div class="save_area">
                                	<div id="continue_target-wrapper" class="fltR">
                                        <div id="continue_target-element" class="form-element">
                                            ...
                                            <button name="continue_target" id="continue_target" type="button"
                                                    class="orngBtn">
                                                Next
                                            </button>
                                        </div>
...
//        }
        ...
        function adStepOneValidation(value) {
            ...
            if (image_file_id < 1) {
                $('#image').after('<p class="adsError">please select image to continue.</p>');
                is_false = true;
            }
