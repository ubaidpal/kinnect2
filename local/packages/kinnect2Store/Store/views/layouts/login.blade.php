...
<div class="container">
	...
	<script src="{!! asset('local/public/assets/js/login-page/modernizr.custom.js') !!}"></script>
    <script src="{!! asset('local/public/assets/js/login-page/slider-img-loader.min.js') !!}"></script>
    <script src="{!! asset('local/public/assets/js/login-page/bg-slider.min.js') !!}"></script>
    <script>
