        ...
        <div class="addProduct">
            ...
            <div class="dispute-wrapper">
                ...
                <div class="field-item">
                    <div class="request-note">Please complete the request from below
                    </div>
                </div>
                ...
                <div class="field-item dispute-row">
                    ...
                    <div class="detail bb">
                        <label>Yes<input type="radio" name="order_receive" class="order_receive" id=""
                                         value="Yes"></label>
                        <label>No<input type="radio" name="order_receive" class="order_receive" id=""
                                        value="No"></label>
                        ...
                        <div class="detail bb">
                            ...
                            <div>Shipping Time:
                              ...
                              value="{{$payment_received[0]->gateway_timestamp}}" style="width:auto; padding:0px;" disabled>--}}
                                <input type="text" name="shipping_time" id="shipping_time" class="shipping_time"
                                       value="{{$deliveryInfo->date_to_be_delivered}}" style="width:auto; padding:0px;"
                                       disabled>
                            </div>
                        </div>
                </div>
                ...
                <div class="field-item dispute-row">
                    ...
                    <div class="detail bb">
                        <label>Full Refund<input type="radio" id="full_refund" name="refund" class="refund"
                                                 id="full_refund" value="full"></label><br/><br/>
                        <label id="refund_txt">Partial Refund Amount Request: $
                            <input type="radio" name="refund"
                                   class="refund"
                                   id="order_receive"
                                   value="partial">
                            <input type="text" name="claimed_amount" value="" id="partial_refund" class="full_refund"
                                   placeholder="amount" disabled>
                            <br>
                            <small>Maximum amount to be
                                claimed {{format_currency($order->total_price - $order->total_discount)}}</small>
                        </label>
                ...
                <div class="field-item dispute-row">
                    <div class="title mW">{!! Form::label('Reason:') !!}</div>
                    <div class="detail bb">
                ...
                <div class="field-item dispute-row">
                    ...
                    @foreach($products as $product)
                        ...
                        <div class="detail bb">
                            <div class="image-box">
                                <img src="{{ getProductPhotoSrc('','',$product->id, 'product_profile') }}" width="150"
                                     height="100" alt="img">
                            </div>
                            <div class="price-box">{{format_currency($product->price)}}</div>
                            <div class="select-product">
                                {!! Form::checkbox('products[]',$product->id, TRUE ,["style" => "width:auto;"]) !!}
                            </div>
                ...
                <div class="field-item dispute-row">
                    ...
                    <div id="images_selection_wrap" class="select-img m0 detail bb">
...
<script language="javascript" type="text/javascript">
    ...
    $(document).on("click", "#add_product_btn", function (evt) {
        ...
        if ($('input[class=order_receive]:checked').length <= 0) {
            $("#info1").html('Order Status is not selected.').show();
            setTimeout(function () {
                $('#info1').fadeOut('slow');
            }, 4000);
            return false;
        ...
        if ($('input[class=refund]:checked').length <= 0) {
            $("#info2").html('Refund request not selected.').show();
            setTimeout(function () {
                $('#info2').fadeOut('slow');
            }, 4000);
            return false;
