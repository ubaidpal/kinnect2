		...
		<div class="brand-store-img-title">
			...
			<div class="product-detail-wrapper">
				...
				@if($productAttributes)
					@foreach($productAttributes as $key => $productAttributeColor)
						<?php
						if($productAttributeColor->attribute != "color"){continue;}
						$count++;
						if($count == 1){?>
						<div class="product-list-wrapper">
							...
							<div class="detail">
								...
								?>
								<a href="javascript:void(0);" id="color_{{$productAttributeColor->id}}" class="cs-item cart_product_color_selection">{{$productAttributeColor->value}}</a>
								@endforeach
								<?php if($count > 0){ ?>
							</div>
						</div><?php }?>
						...
						<?php $countSize = 0; ?>
						@if($productAttributes)
							@foreach($productAttributes as $key => $productAttributeSize)
								<?php
								if($productAttributeSize->attribute != "size"){continue;}
								$countSize++;
								if($countSize == 1){?>
								<div class="product-list-wrapper">
									...
									<div class="detail">
										...
										?>
										<a href="javascript:void(0);" id="size_{{$productAttributeSize->id}}" class="cs-item   cart_product_size_selection">{{$productAttributeSize->value}}</a>
										@endforeach
										<?php if($countSize > 0){ ?>
									</div>
								</div><?php }?>
								...
								<div class="product-list-wrapper">
									...
									<div class="detail">
										...
										<div class="alert" id="shipping-error">We do not deliver to your selected Country/Region.</div>
									</div>
								</div>
			</div>
			...
			<div class="return-policy">
				...
				<div class="feed-options mt10 mb10">
